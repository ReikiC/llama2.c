/* fp32 backend: the Llama-2 Transformer weights, run state, checkpoint loader,
 * memory mapping, and the forward pass with a float matmul.
 * Linked into the `run` binary. */
